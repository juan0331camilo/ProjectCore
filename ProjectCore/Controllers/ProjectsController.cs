...
namespace ProjectCore.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        //ESTE METODO CARGA LA VISTA CREATE QUE LE ESTAMOS ENVIANDO DESDE EL HTML CREATE
        ...
        public async Task<IActionResult> Create(Logica.Models.BindingModel.ProjectsCreateBindingModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Logica.BL.Projects projects = new Logica.BL.Projects();
                projects.CreateProjects(model.Title, model.Title, model.ExpectedCompletionDate, tenant.Id);
